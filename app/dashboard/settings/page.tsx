...
export default function SettingsPage() {
  ...
  const [connectedAccounts] = useState([
    { platform: "Instagram", username: "@techcorp", connected: true, followers: "12.4K" },
    { platform: "Twitter", username: "@techcorp", connected: true, followers: "8.7K" },
    { platform: "Facebook", username: "TechCorp Inc.", connected: true, followers: "15.2K" },
    { platform: "LinkedIn", username: "TechCorp Inc.", connected: false, followers: "0" },
  ])
